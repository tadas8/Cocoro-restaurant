	...
	<td>
		...
		<?php elseif ( ( WC()->countries->get_states( WC()->customer->get_shipping_country() ) && ! WC()->customer->get_shipping_state() ) || ! WC()->customer->get_shipping_postcode() ) : ?>
			...
			<?php elseif ( is_cart() ) : ?>
				...
				<p><?php _e( 'Please continue to the checkout and enter your full address to see if there are any available shipping methods. <span style="color:red;">Our delivery is available in N6, N2, N19, N8 and N10 of London.</span>', 'woocommerce' ); ?></p>

			<?php else : ?>

				<p><?php _e( 'Please fill in your details to see available shipping methods. <span style="color:red;">Our delivery is available in N6, N2, N19, N8 and N10 of London.</span>', 'woocommerce' ); ?></p>
